...
public class Camera {
    ...
    // @TODO put the actual key
    private static final String VUFORIA_KEY =
            " -- YOUR NEW VUFORIA KEY GOES HERE  --- ";


    //Begin Camera Constants
    ...
    public RobotPosition getCurrentPosition(boolean isStop){
        ...
        while (timer.time() <= 1 && !isStop) {
            ...
            if (targetVisible) {
                ...
                robotPosition.rot = rotation.firstAngle - 90.0;
            }
    ...
    public TfodOutput runTfod(boolean isStop){
        TfodOutput tf = new TfodOutput();
        tf.pos = 4;
        tf.rot = 0;
                ...
                if (updatedRecognitions != null) {
                    ...
                    for (Recognition recognition : updatedRecognitions) {
                        if (recognition.getLabel() == LABEL_SECOND_ELEMENT) {
                            tf.rot = recognition.estimateAngleToObject(AngleUnit.DEGREES);
    ...
    private Bitmap getBitmap(){
        //*****************MAY Already be Done As Part of VUFORIA Initialization*******
        ...
        while(timer.seconds() < 2){
            ...
            int numImages=(int)frame.getNumImages();
